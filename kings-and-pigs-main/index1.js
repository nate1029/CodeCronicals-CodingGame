...
let levels = {
  1: {
    init: () => {
      ...
      doors = [
        new Sprite({ position: { x: 767, y: 270 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 1025, y: 270 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 1280, y: 270 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 1550, y: 270 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
      ];
    },
  },
  2: {
    init: () => {
      ...
      doors = [
        new Sprite({ position: { x: 772, y: 336 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 1078, y: 336 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 1300, y: 336 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 1550, y: 336 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
      ];
    },
  },
  3: {
    init: () => {
      ...
      doors = [
        new Sprite({ position: { x: 176, y: 335 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 300, y: 335 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 450, y: 335 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
        new Sprite({ position: { x: 600, y: 335 }, imageSrc: './img/doorOpen.png', frameRate: 5, frameBuffer: 5, loop: false, autoplay: false }),
      ];
    },
  },
};
